...
import com.example.helloworld.EatDetAdm
...
class ListEatAdm(var list: List<EatObject>): RecyclerView.Adapter<RecyclerView.ViewHolder>(){
    ...
    class DescViewHolder(item: View): RecyclerView.ViewHolder(item){
        fun bind(eat: EatObject){
            ...
            itemView.setOnClickListener{
                val intent= Intent(itemView.context, EatDetAdm::class.java)


                intent.putExtra("eat_id",eat.description+eat.date)
