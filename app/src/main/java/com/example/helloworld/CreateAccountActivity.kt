...
class CreateAccountActivity : AppCompatActivity() {
    ...
    private fun initialise(){
        ...
        btnCreate!!.setOnClickListener {
            ...
            val builder = AlertDialog.Builder(this@CreateAccountActivity,R.style.AlertDialogStyle)
...
//      selectphoto_button_register.setBackgroundDrawable(bitmapDrawable)
    ...
    private fun createNewAccount(link: String) {
        ...
        if (TextUtils.isEmpty(username) ) {
            etUsername?.setError("informe seu nome de usuário")
            valid=false
        }
            ...
            etId?.setError("informe sua matrícula")
            valid=false
        }
        ...
        mAuth!!
            .createUserWithEmailAndPassword(email!!,pass!!).addOnCompleteListener(this){
                ...
                if(task.isSuccessful){
                    ...
                    // verifyEmail()
                    val testUser= UserObject(username=username,email = email,id = id,authId = userId,role = "user",image=link)
                    ...
                    db!!.collection("user").document(userId)
                        ...
                        .addOnFailureListener { e ->
                            ...
                            Toast.makeText(this,"Falha do cadastro, tente novamente mais tarde!",Toast.LENGTH_SHORT).show()
                        }
                    updateUserUI()
                } else{
